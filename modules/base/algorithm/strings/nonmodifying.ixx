...
int CmpNoCase(std::string_view strViewA, std::string_view strViewB)
{
    ...
    std::ranges::transform(strViewA, strA.begin(), [](auto c) noexcept { return nil::utils::ToLowerCh(c); });
    std::ranges::transform(strViewB, strB.begin(), [](auto c) noexcept { return nil::utils::ToLowerCh(c); });
