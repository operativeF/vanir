#ifndef POTATO_UNITS_PRESSURE_HPP_INCLUDED
#define POTATO_UNITS_PRESSURE_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct pascal_impl {
            ...
            constexpr pascal_impl<T, P>() : value(0) {}
            constexpr pascal_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const pascal_impl<T, P>(const pascal_impl<U, R>& other) {
...
#endif // POTATO_UNITS_PASCAL_HPP_INCLUDED