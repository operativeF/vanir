#ifndef POTATO_UNITS_MAGNETIC_FLUX_HPP_INCLUDED
#define POTATO_UNITS_MAGNETIC_FLUX_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct weber_impl {
            ...
            constexpr weber_impl<T, P>() : value(0) {}
            constexpr weber_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const weber_impl<T, P>(const weber_impl<U, R>& other) {
...
#endif // POTATO_UNITS_WEBER_HPP_INCLUDED