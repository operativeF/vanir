#ifndef POTATO_UNITS_RESISTANCE_HPP_INCLUDED
#define POTATO_UNITS_RESISTANCE_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct ohm_impl {
            ...
            constexpr ohm_impl<T, P>() : value(0) {}
            constexpr ohm_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const ohm_impl<T, P>(const ohm_impl<U, R>& other) {
...
#endif // POTATO_UNITS_OHM_HPP_INCLUDED