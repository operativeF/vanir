...
export namespace potato::units {
    ...
    using ohm_tag_t = tmp::list_<tmp::list_<meter_l, meter_l, gram_l>, tmp::list_<second_l, second_l, second_l, ampere_l, ampere_l>>;

    template<typename T>
    concept OhmC = std::same_as<typename T::impl, ohm_tag_t>;
