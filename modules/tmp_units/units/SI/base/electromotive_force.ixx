...
export namespace potato::units {
    ...
    using volt_tag_t = tmp::list_<tmp::list_<meter_l, meter_l, gram_l>, tmp::list_<second_l, second_l, second_l, ampere_l>>;

    template<typename T>
    concept VoltC = std::same_as<typename T::impl, volt_tag_t>;
