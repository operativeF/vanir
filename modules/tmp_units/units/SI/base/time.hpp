#ifndef POTATO_UNITS_TIME_HPP_INCLUDED
#define POTATO_UNITS_TIME_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct second_impl {
            ...
            constexpr second_impl<T, P>() : value(0) {}
            constexpr second_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const second_impl<T, P>(const second_impl<U, R>& other) {
...
#endif // POTATO_UNITS_SECOND_HPP_INCLUDED