#ifndef POTATO_UNITS_ILLUMINANCE_HPP_INCLUDED
#define POTATO_UNITS_ILLUMINANCE_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct lux_impl {
            ...
            constexpr lux_impl<T, P>() : value(0) {}
            constexpr lux_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const lux_impl<T, P>(const lux_impl<U, R>& other) {
...
#endif // POTATO_UNITS_LUX_HPP_INCLUDED