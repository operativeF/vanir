#ifndef POTATO_UNITS_LUMINOUS_FLUX_HPP_INCLUDED
#define POTATO_UNITS_LUMINOUS_FLUX_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct lumen_impl {
            ...
            constexpr lumen_impl<T, P>() : value(0) {}
            constexpr lumen_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const lumen_impl<T, P>(const lumen_impl<U, R>& other) {
...
#endif // POTATO_UNITS_LUMEN_HPP_INCLUDED