#ifndef POTATO_UNITS_RADIONUCLIDE_ACTIVITY_HPP_INCLUDED
#define POTATO_UNITS_RADIONUCLIDE_ACTIVITY_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct becquerel_impl {
            ...
            constexpr becquerel_impl<T, P>() : value(0) {}
            constexpr becquerel_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const becquerel_impl<T, P>(const becquerel_impl<U, R>& other) {
...
#endif // POTATO_UNITS_BECQUEREL_HPP_INCLUDED