...
export namespace potato::units {
    ...
    using tesla_tag_t = tmp::list_<tmp::list_<gram_l>, tmp::list_<second_l, second_l, ampere_l>>;

    template<typename T>
    concept TeslaC = std::same_as<typename T::impl, tesla_tag_t>;
