#ifndef POTATO_UNITS_LENGTH_HPP_INCLUDED
#define POTATO_UNITS_LENGTH_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct meter_impl {
            ...
            constexpr meter_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const meter_impl<T, P>(const meter_impl<U, R>& other) {
...
#endif // POTATO_UNITS_METER_HPP_INCLUDED