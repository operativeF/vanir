#ifndef POTATO_UNITS_SOLID_ANGLE_HPP_INCLUDED
#define POTATO_UNITS_SOLID_ANGLE_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct steradian_impl {
            ...
            constexpr steradian_impl<T, P>() : value(0) {}
            constexpr steradian_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const steradian_impl<T, P>(const steradian_impl<U, R>& other) {
...
#endif // POTATO_UNITS_STERADIAN_HPP_INCLUDED