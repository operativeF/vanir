#ifndef POTATO_UNITS_PLANE_ANGLE_HPP_INCLUDED
#define POTATO_UNITS_PLANE_ANGLE_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct radian_impl {
            ...
            constexpr radian_impl<T, P>() : value(0) {}
            constexpr radian_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const radian_impl<T, P>(const radian_impl<U, R>& other) {
            ...
            using mod_ratio = T;
            using impl      = list_<list_<radian_l>, list_<>>;
        };
...
#endif // POTATO_UNITS_RADIAN_HPP_INCLUDED