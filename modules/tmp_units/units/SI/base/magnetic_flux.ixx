...
export namespace potato::units {
    ...
    using weber_tag_t = tmp::list_<tmp::list_<meter_l, meter_l, gram_l>, tmp::list_<second_l, second_l, ampere_l>>;

    template<typename T>
    concept WeberC = std::same_as<typename T::impl, weber_tag_t>;
