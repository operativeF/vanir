#ifndef POTATO_UNITS_ELECTROMOTIVE_FORCE_HPP_INCLUDED
#define POTATO_UNITS_ELECTROMOTIVE_FORCE_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct volt_impl {
            ...
            constexpr volt_impl<T, P>() : value(0) {}
            constexpr volt_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const volt_impl<T, P>(const volt_impl<U, R>& other) {
...
#endif // POTATO_UNITS_VOLT_HPP_INCLUDED