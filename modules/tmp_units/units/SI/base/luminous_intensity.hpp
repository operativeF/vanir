#ifndef POTATO_UNITS_LUMINOUS_INTENSITY_HPP_INCLUDED
#define POTATO_UNITS_LUMINOUS_INTENSITY_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct candela_impl {
            ...
            constexpr candela_impl<T, P>() : value(0) {}
            constexpr candela_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const candela_impl<T, P>(const candela_impl<U, R>& other) {
...
#endif // POTATO_UNITS_CANDELA_HPP_INCLUDED