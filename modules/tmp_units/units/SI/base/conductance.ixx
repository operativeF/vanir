...
export namespace potato::units {
    ...
    using siemens_tag_t = tmp::list_<tmp::list_<second_l, second_l, second_l, ampere_l, ampere_l>, tmp::list_<meter_l, meter_l, gram_l>>;

    template<typename T>
    concept SiemensC = std::same_as<typename T::impl, siemens_tag_t>;
