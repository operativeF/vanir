...
export namespace potato::units {
    ...
    consteval exapascal_ld operator""_EPa(long double val) {
        return static_cast<exapascal_ld>(val);
    }
    consteval petapascal_ld operator""_PPa(long double val) {
        return static_cast<petapascal_ld>(val);
    }
    consteval terapascal_ld operator""_TPa(long double val) {
        return static_cast<terapascal_ld>(val);
    }
    consteval gigapascal_ld operator""_GPa(long double val) {
        return static_cast<gigapascal_ld>(val);
    }
    consteval megapascal_ld operator""_MPa(long double val) {
        return static_cast<megapascal_ld>(val);
    }
    consteval kilopascal_ld operator""_kPa(long double val) {
        return static_cast<kilopascal_ld>(val);
    }
    consteval hectopascal_ld operator""_hPa(long double val) {
        return static_cast<hectopascal_ld>(val);
    }
    consteval decapascal_ld operator""_daPa(long double val) {
        return static_cast<decapascal_ld>(val);
    }
    consteval pascal_ld operator""_Pa(long double val) {
        return static_cast<pascal_ld>(val);
    }
    consteval decipascal_ld operator""_dPa(long double val) {
        return static_cast<decipascal_ld>(val);
    }
    consteval centipascal_ld operator""_cPa(long double val) {
        return static_cast<centipascal_ld>(val);
    }
    consteval millipascal_ld operator""_mPa(long double val) {
        return static_cast<millipascal_ld>(val);
    }
    consteval micropascal_ld operator""_uPa(long double val) {
        return static_cast<micropascal_ld>(val);
    }
    consteval nanopascal_ld operator""_nPa(long double val) {
        return static_cast<nanopascal_ld>(val);
    }
    consteval picopascal_ld operator""_pPa(long double val) {
        return static_cast<picopascal_ld>(val);
    }
    consteval femtopascal_ld operator""_fPa(long double val) {
        return static_cast<femtopascal_ld>(val);
    }
    consteval attopascal_ld operator""_aPa(long double val) {
        return static_cast<attopascal_ld>(val);
    }
    consteval exapascal_ull operator""_EPa(unsigned long long val) {
        return static_cast<exapascal_ull>(val);
    }
    consteval petapascal_ull operator""_PPa(unsigned long long val) {
        return static_cast<petapascal_ull>(val);
    }
    consteval terapascal_ull operator""_TPa(unsigned long long val) {
        return static_cast<terapascal_ull>(val);
    }
    consteval gigapascal_ull operator""_GPa(unsigned long long val) {
        return static_cast<gigapascal_ull>(val);
    }
    consteval megapascal_ull operator""_MPa(unsigned long long val) {
        return static_cast<megapascal_ull>(val);
    }
    consteval kilopascal_ull operator""_kPa(unsigned long long val) {
        return static_cast<kilopascal_ull>(val);
    }
    consteval hectopascal_ull operator""_hPa(unsigned long long val) {
        return static_cast<hectopascal_ull>(val);
    }
    consteval decapascal_ull operator""_daPa(unsigned long long val) {
        return static_cast<decapascal_ull>(val);
    }
    consteval pascal_ull operator""_Pa(unsigned long long val) {
        return static_cast<pascal_ull>(val);
    }
    consteval decipascal_ull operator""_dPa(unsigned long long val) {
        return static_cast<decipascal_ull>(val);
    }
    consteval centipascal_ull operator""_cPa(unsigned long long val) {
        return static_cast<centipascal_ull>(val);
    }
    consteval millipascal_ull operator""_mPa(unsigned long long val) {
        return static_cast<millipascal_ull>(val);
    }
    consteval micropascal_ull operator""_uPa(unsigned long long val) {
        return static_cast<micropascal_ull>(val);
    }
    consteval nanopascal_ull operator""_nPa(unsigned long long val) {
        return static_cast<nanopascal_ull>(val);
    }
    consteval picopascal_ull operator""_pPa(unsigned long long val) {
        return static_cast<picopascal_ull>(val);
    }
    consteval femtopascal_ull operator""_fPa(unsigned long long val) {
        return static_cast<femtopascal_ull>(val);
    }
    consteval attopascal_ull operator""_aPa(unsigned long long val) {
