...
export namespace potato::units {
    ...
    using pascal_tag_t = tmp::list_<tmp::list_<gram_l>, tmp::list_<meter_l, second_l, second_l>>;

    template<typename T>
    concept PascalC = std::same_as<typename T::impl, pascal_tag_t>;
