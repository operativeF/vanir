#ifndef POTATO_UNITS_CONDUCTANCE_HPP_INCLUDED
#define POTATO_UNITS_CONDUCTANCE_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct siemens_impl {
            ...
            constexpr siemens_impl<T, P>() : value(0) {}
            constexpr siemens_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const siemens_impl<T, P>(const siemens_impl<U, R>& other) {
...
#endif // POTATO_UNITS_SIEMENS_HPP_INCLUDED