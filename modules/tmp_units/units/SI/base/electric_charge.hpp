#ifndef POTATO_UNITS_ELECTRIC_CHARGE_HPP_INCLUDED
#define POTATO_UNITS_ELECTRIC_CHARGE_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct coulomb_impl {
            ...
            constexpr coulomb_impl<T, P>() : value(0) {}
            constexpr coulomb_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const coulomb_impl<T, P>(const coulomb_impl<U, R>& other) {
...
#endif // POTATO_UNITS_COULOMB_HPP_INCLUDED