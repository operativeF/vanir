#ifndef POTATO_UNITS_POWER_HPP_INCLUDED
#define POTATO_UNITS_POWER_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct watt_impl {
            ...
            constexpr watt_impl<T, P>() : value(0) {}
            constexpr watt_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const watt_impl<T, P>(const watt_impl<U, R>& other) {
            ...
            using mod_ratio = T;
            using impl      = list_<list_<meter_l, meter_l, gram_l>, list_<second_l, second_l, second_l>>;
        };
...
#endif // POTATO_UNITS_WATT_HPP_INCLUDED