#ifndef POTATO_UNITS_MASS_HPP_INCLUDED
#define POTATO_UNITS_MASS_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct gram_impl {
            ...
            constexpr gram_impl<T, P>() : value(0) {}
            constexpr gram_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const gram_impl<T, P>(const gram_impl<U, R>& other) {
            ...
            using mod_ratio = T;
            using impl      = list_<list_<gram_l>, list_<>>;
        };
...
#endif // POTATO_UNITS_GRAM_HPP_INCLUDED