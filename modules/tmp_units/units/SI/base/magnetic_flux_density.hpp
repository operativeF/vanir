#ifndef POTATO_UNITS_MAGNETIC_FLUX_DENSITY_HPP_INCLUDED
#define POTATO_UNITS_MAGNETIC_FLUX_DENSITY_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct tesla_impl {
            ...
            constexpr tesla_impl<T, P>() : value(0) {}
            constexpr tesla_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const tesla_impl<T, P>(const tesla_impl<U, R>& other) {
            ...
            using mod_ratio = T;
            using impl      = list_<list_<gram_l>, list_<second_l, second_l, ampere_l>>;
        };
...
#endif // POTATO_UNITS_TESLA_HPP_INCLUDED