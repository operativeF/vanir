#ifndef POTATO_UNITS_ELECTRIC_FLUX_HPP_INCLUDED
#define POTATO_UNITS_ELECTRIC_FLUX_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct volt_meter_impl {
            ...
            constexpr volt_meter_impl<T, P>() : value(0) {}
            constexpr volt_meter_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const volt_meter_impl<T, P>(const volt_meter_impl<U, R>& other) {
...
#endif // POTATO_UNITS_VOLT_METER_HPP_INCLUDED