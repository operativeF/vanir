...
export namespace potato::units {
    ...
    using current_density_tag_t = tmp::list_<Length<std::ratio<-2, 1>>,
                                         Time<std::ratio<0, 1>>,
                                         Mass<std::ratio<0, 1>>,
    ...
    template<typename T>
    concept Ampere_Per_Square_MeterC = std::same_as<typename T::impl, current_density_tag_t>;
    ...
    struct ampere_per_square_meter_impl {
        ...
        using impl       = current_density_tag_t;
    ...
    consteval exaampere_per_square_meter_ld operator""_EA_per_sq_m(long double val) {
        return static_cast<exaampere_per_square_meter_ld>(val);
    }
    consteval petaampere_per_square_meter_ld operator""_PA_per_sq_m(long double val) {
        return static_cast<petaampere_per_square_meter_ld>(val);
    }
    consteval teraampere_per_square_meter_ld operator""_TA_per_sq_m(long double val) {
        return static_cast<teraampere_per_square_meter_ld>(val);
    }
    consteval gigaampere_per_square_meter_ld operator""_GA_per_sq_m(long double val) {
        return static_cast<gigaampere_per_square_meter_ld>(val);
    }
    consteval megaampere_per_square_meter_ld operator""_MA_per_sq_m(long double val) {
        return static_cast<megaampere_per_square_meter_ld>(val);
    }
    consteval kiloampere_per_square_meter_ld operator""_kA_per_sq_m(long double val) {
        return static_cast<kiloampere_per_square_meter_ld>(val);
    }
    consteval hectoampere_per_square_meter_ld operator""_hA_per_sq_m(long double val) {
        return static_cast<hectoampere_per_square_meter_ld>(val);
    }
    consteval decaampere_per_square_meter_ld operator""_daA_per_sq_m(long double val) {
        return static_cast<decaampere_per_square_meter_ld>(val);
    }
    consteval ampere_per_square_meter_ld operator""_A_per_sq_m(long double val) {
        return static_cast<ampere_per_square_meter_ld>(val);
    }
    consteval deciampere_per_square_meter_ld operator""_dA_per_sq_m(long double val) {
        return static_cast<deciampere_per_square_meter_ld>(val);
    }
    consteval centiampere_per_square_meter_ld operator""_cA_per_sq_m(long double val) {
        return static_cast<centiampere_per_square_meter_ld>(val);
    }
    consteval milliampere_per_square_meter_ld operator""_mA_per_sq_m(long double val) {
        return static_cast<milliampere_per_square_meter_ld>(val);
    }
    consteval microampere_per_square_meter_ld operator""_uA_per_sq_m(long double val) {
        return static_cast<microampere_per_square_meter_ld>(val);
    }
    consteval nanoampere_per_square_meter_ld operator""_nA_per_sq_m(long double val) {
        return static_cast<nanoampere_per_square_meter_ld>(val);
    }
    consteval picoampere_per_square_meter_ld operator""_pA_per_sq_m(long double val) {
        return static_cast<picoampere_per_square_meter_ld>(val);
    }
    consteval femtoampere_per_square_meter_ld operator""_fA_per_sq_m(long double val) {
        return static_cast<femtoampere_per_square_meter_ld>(val);
    }
    consteval attoampere_per_square_meter_ld operator""_aA_per_sq_m(long double val) {
        return static_cast<attoampere_per_square_meter_ld>(val);
    }
    consteval exaampere_per_square_meter_ull operator""_EA_per_sq_m(unsigned long long val) {
        return static_cast<exaampere_per_square_meter_ull>(val);
    }
    consteval petaampere_per_square_meter_ull operator""_PA_per_sq_m(unsigned long long val) {
        return static_cast<petaampere_per_square_meter_ull>(val);
    }
    consteval teraampere_per_square_meter_ull operator""_TA_per_sq_m(unsigned long long val) {
        return static_cast<teraampere_per_square_meter_ull>(val);
    }
    consteval gigaampere_per_square_meter_ull operator""_GA_per_sq_m(unsigned long long val) {
        return static_cast<gigaampere_per_square_meter_ull>(val);
    }
    consteval megaampere_per_square_meter_ull operator""_MA_per_sq_m(unsigned long long val) {
        return static_cast<megaampere_per_square_meter_ull>(val);
    }
    consteval kiloampere_per_square_meter_ull operator""_kA_per_sq_m(unsigned long long val) {
        return static_cast<kiloampere_per_square_meter_ull>(val);
    }
    consteval hectoampere_per_square_meter_ull operator""_hA_per_sq_m(unsigned long long val) {
        return static_cast<hectoampere_per_square_meter_ull>(val);
    }
    consteval decaampere_per_square_meter_ull operator""_daA_per_sq_m(unsigned long long val) {
        return static_cast<decaampere_per_square_meter_ull>(val);
    }
    consteval ampere_per_square_meter_ull operator""_A_per_sq_m(unsigned long long val) {
        return static_cast<ampere_per_square_meter_ull>(val);
    }
    consteval deciampere_per_square_meter_ull operator""_dA_per_sq_m(unsigned long long val) {
        return static_cast<deciampere_per_square_meter_ull>(val);
    }
    consteval centiampere_per_square_meter_ull operator""_cA_per_sq_m(unsigned long long val) {
        return static_cast<centiampere_per_square_meter_ull>(val);
    }
    consteval milliampere_per_square_meter_ull operator""_mA_per_sq_m(unsigned long long val) {
        return static_cast<milliampere_per_square_meter_ull>(val);
    }
    consteval microampere_per_square_meter_ull operator""_uA_per_sq_m(unsigned long long val) {
        return static_cast<microampere_per_square_meter_ull>(val);
    }
    consteval nanoampere_per_square_meter_ull operator""_nA_per_sq_m(unsigned long long val) {
        return static_cast<nanoampere_per_square_meter_ull>(val);
    }
    consteval picoampere_per_square_meter_ull operator""_pA_per_sq_m(unsigned long long val) {
        return static_cast<picoampere_per_square_meter_ull>(val);
    }
    consteval femtoampere_per_square_meter_ull operator""_fA_per_sq_m(unsigned long long val) {
        return static_cast<femtoampere_per_square_meter_ull>(val);
    }
    consteval attoampere_per_square_meter_ull operator""_aA_per_sq_m(unsigned long long val) {
