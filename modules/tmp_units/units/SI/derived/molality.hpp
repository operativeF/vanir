#ifndef POTATO_UNITS_MOLALITY_HPP_INCLUDED
#define POTATO_UNITS_MOLALITY_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct mole_per_kilogram_impl {
            ...
            constexpr mole_per_kilogram_impl<T, P>() : value(0) {}
            constexpr mole_per_kilogram_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const mole_per_kilogram_impl<T, P>(const mole_per_kilogram_impl<U, R>& other) {
...
#endif // POTATO_UNITS_MOLE_PER_KILOGRAM_HPP_INCLUDED