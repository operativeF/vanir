#ifndef POTATO_UNITS_SPECTRAL_IRRADIANCE_HPP_INCLUDED
#define POTATO_UNITS_SPECTRAL_IRRADIANCE_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct watt_per_cubic_meter_impl {
            ...
            constexpr watt_per_cubic_meter_impl<T, P>() : value(0) {}
            constexpr watt_per_cubic_meter_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const watt_per_cubic_meter_impl<T, P>(const watt_per_cubic_meter_impl<U, R>& other) {
...
#endif // POTATO_UNITS_WATT_PER_CUBIC_METER_HPP_INCLUDED