...
export namespace potato::units {
    ...
    using radian_per_second_tag_t = tmp::list_<tmp::list_<radian_l>, tmp::list_<second_l>>;

    template<typename T>
    concept Radian_Per_SecondC = std::same_as<typename T::impl, radian_per_second_tag_t>;
    ...
    struct radian_per_second_impl {
        ...
        using impl       = radian_per_second_tag_t;
