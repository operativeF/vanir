#ifndef POTATO_UNITS_CATALYTIC_ACTIVITY_CONCENTRATION_HPP_INCLUDED
#define POTATO_UNITS_CATALYTIC_ACTIVITY_CONCENTRATION_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct katal_per_cubic_meter_impl {
            ...
            constexpr katal_per_cubic_meter_impl<T, P>() : value(0) {}
            constexpr katal_per_cubic_meter_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const katal_per_cubic_meter_impl<T, P>(const katal_per_cubic_meter_impl<U, R>& other) {
...
#endif // POTATO_UNITS_KATAL_PER_CUBIC_METER_HPP_INCLUDED