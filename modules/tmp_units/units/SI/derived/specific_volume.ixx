...
export namespace potato::units {
    ...
    struct cubic_meter_per_kilogram_impl : base_unit_<RatioTypeT, P> {

        using base_unit_<RatioTypeT, P>::base_unit_;
        template <typename U, typename R>
        constexpr const cubic_meter_per_kilogram_impl<RatioTypeT, P>(const cubic_meter_per_kilogram_impl<U, R>& other) {
