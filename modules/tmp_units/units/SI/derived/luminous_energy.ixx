...
export namespace potato::units {
    ...
    using lumen_second_tag_t = tmp::list_<tmp::list_<second_l, candela_l>, tmp::list_<>>;

    template<typename T>
    concept Lumen_SecondC = std::same_as<typename T::impl, lumen_second_tag_t>;
