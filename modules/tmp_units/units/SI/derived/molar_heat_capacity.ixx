...
export namespace potato::units {
    ...
    using molar_heat_capacity_tag_t = tmp::list_<Length<std::ratio<2, 1>>,
                                         Time<std::ratio<-2, 1>>,
                                         Mass<std::ratio<1, 1>>,
    ...
    template<typename T>
    concept Joule_Per_Mole_KelvinC = std::same_as<typename T::impl, molar_heat_capacity_tag_t>;
    ...
    struct joule_per_mole_kelvin_impl {
        ...
        using impl       = molar_heat_capacity_tag_t;
    ...
    consteval exajoule_per_mole_kelvin_ld operator""_EJ_per_mol_K(long double val) {
        return static_cast<exajoule_per_mole_kelvin_ld>(val);
    }
    consteval petajoule_per_mole_kelvin_ld operator""_PJ_per_mol_K(long double val) {
        return static_cast<petajoule_per_mole_kelvin_ld>(val);
    }
    consteval terajoule_per_mole_kelvin_ld operator""_TJ_per_mol_K(long double val) {
        return static_cast<terajoule_per_mole_kelvin_ld>(val);
    }
    consteval gigajoule_per_mole_kelvin_ld operator""_GJ_per_mol_K(long double val) {
        return static_cast<gigajoule_per_mole_kelvin_ld>(val);
    }
    consteval megajoule_per_mole_kelvin_ld operator""_MJ_per_mol_K(long double val) {
        return static_cast<megajoule_per_mole_kelvin_ld>(val);
    }
    consteval kilojoule_per_mole_kelvin_ld operator""_kJ_per_mol_K(long double val) {
        return static_cast<kilojoule_per_mole_kelvin_ld>(val);
    }
    consteval hectojoule_per_mole_kelvin_ld operator""_hJ_per_mol_K(long double val) {
        return static_cast<hectojoule_per_mole_kelvin_ld>(val);
    }
    consteval decajoule_per_mole_kelvin_ld operator""_daJ_per_mol_K(long double val) {
        return static_cast<decajoule_per_mole_kelvin_ld>(val);
    }
    consteval joule_per_mole_kelvin_ld operator""_J_per_mol_K(long double val) {
        return static_cast<joule_per_mole_kelvin_ld>(val);
    }
    consteval decijoule_per_mole_kelvin_ld operator""_dJ_per_mol_K(long double val) {
        return static_cast<decijoule_per_mole_kelvin_ld>(val);
    }
    consteval centijoule_per_mole_kelvin_ld operator""_cJ_per_mol_K(long double val) {
        return static_cast<centijoule_per_mole_kelvin_ld>(val);
    }
    consteval millijoule_per_mole_kelvin_ld operator""_mJ_per_mol_K(long double val) {
        return static_cast<millijoule_per_mole_kelvin_ld>(val);
    }
    consteval microjoule_per_mole_kelvin_ld operator""_uJ_per_mol_K(long double val) {
        return static_cast<microjoule_per_mole_kelvin_ld>(val);
    }
    consteval nanojoule_per_mole_kelvin_ld operator""_nJ_per_mol_K(long double val) {
        return static_cast<nanojoule_per_mole_kelvin_ld>(val);
    }
    consteval picojoule_per_mole_kelvin_ld operator""_pJ_per_mol_K(long double val) {
        return static_cast<picojoule_per_mole_kelvin_ld>(val);
    }
    consteval femtojoule_per_mole_kelvin_ld operator""_fJ_per_mol_K(long double val) {
        return static_cast<femtojoule_per_mole_kelvin_ld>(val);
    }
    consteval attojoule_per_mole_kelvin_ld operator""_aJ_per_mol_K(long double val) {
        return static_cast<attojoule_per_mole_kelvin_ld>(val);
    }
    consteval exajoule_per_mole_kelvin_ull operator""_EJ_per_mol_K(unsigned long long val) {
        return static_cast<exajoule_per_mole_kelvin_ull>(val);
    }
    consteval petajoule_per_mole_kelvin_ull operator""_PJ_per_mol_K(unsigned long long val) {
        return static_cast<petajoule_per_mole_kelvin_ull>(val);
    }
    consteval terajoule_per_mole_kelvin_ull operator""_TJ_per_mol_K(unsigned long long val) {
        return static_cast<terajoule_per_mole_kelvin_ull>(val);
    }
    consteval gigajoule_per_mole_kelvin_ull operator""_GJ_per_mol_K(unsigned long long val) {
        return static_cast<gigajoule_per_mole_kelvin_ull>(val);
    }
    consteval megajoule_per_mole_kelvin_ull operator""_MJ_per_mol_K(unsigned long long val) {
        return static_cast<megajoule_per_mole_kelvin_ull>(val);
    }
    consteval kilojoule_per_mole_kelvin_ull operator""_kJ_per_mol_K(unsigned long long val) {
        return static_cast<kilojoule_per_mole_kelvin_ull>(val);
    }
    consteval hectojoule_per_mole_kelvin_ull operator""_hJ_per_mol_K(unsigned long long val) {
        return static_cast<hectojoule_per_mole_kelvin_ull>(val);
    }
    consteval decajoule_per_mole_kelvin_ull operator""_daJ_per_mol_K(unsigned long long val) {
        return static_cast<decajoule_per_mole_kelvin_ull>(val);
    }
    consteval joule_per_mole_kelvin_ull operator""_J_per_mol_K(unsigned long long val) {
        return static_cast<joule_per_mole_kelvin_ull>(val);
    }
    consteval decijoule_per_mole_kelvin_ull operator""_dJ_per_mol_K(unsigned long long val) {
        return static_cast<decijoule_per_mole_kelvin_ull>(val);
    }
    consteval centijoule_per_mole_kelvin_ull operator""_cJ_per_mol_K(unsigned long long val) {
        return static_cast<centijoule_per_mole_kelvin_ull>(val);
    }
    consteval millijoule_per_mole_kelvin_ull operator""_mJ_per_mol_K(unsigned long long val) {
        return static_cast<millijoule_per_mole_kelvin_ull>(val);
    }
    consteval microjoule_per_mole_kelvin_ull operator""_uJ_per_mol_K(unsigned long long val) {
        return static_cast<microjoule_per_mole_kelvin_ull>(val);
    }
    consteval nanojoule_per_mole_kelvin_ull operator""_nJ_per_mol_K(unsigned long long val) {
        return static_cast<nanojoule_per_mole_kelvin_ull>(val);
    }
    consteval picojoule_per_mole_kelvin_ull operator""_pJ_per_mol_K(unsigned long long val) {
        return static_cast<picojoule_per_mole_kelvin_ull>(val);
    }
    consteval femtojoule_per_mole_kelvin_ull operator""_fJ_per_mol_K(unsigned long long val) {
        return static_cast<femtojoule_per_mole_kelvin_ull>(val);
    }
    consteval attojoule_per_mole_kelvin_ull operator""_aJ_per_mol_K(unsigned long long val) {
