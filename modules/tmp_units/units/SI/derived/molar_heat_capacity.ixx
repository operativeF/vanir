...
export namespace potato::units {
    ...
    struct joule_per_mole_kelvin_impl : base_unit_<RatioTypeT, P> {

        using base_unit_<RatioTypeT, P>::base_unit_;
        template <typename U, typename R>
        constexpr const joule_per_mole_kelvin_impl<RatioTypeT, P>(const joule_per_mole_kelvin_impl<U, R>& other) {
