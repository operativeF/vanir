...
export namespace potato::units {
    ...
    using meter_per_cubic_second_tag_t = tmp::list_<tmp::list_<meter_l>, tmp::list_<second_l, second_l, second_l>>;

    template<typename T>
    concept Meter_Per_Cubic_SecondC = std::same_as<typename T::impl, meter_per_cubic_second_tag_t>;
    ...
    struct meter_per_cubic_second_impl {
        ...
        using impl       = meter_per_cubic_second_tag_t;
