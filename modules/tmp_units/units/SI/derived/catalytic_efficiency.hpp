#ifndef POTATO_UNITS_CATALYTIC_EFFICIENCY_HPP_INCLUDED
#define POTATO_UNITS_CATALYTIC_EFFICIENCY_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct cubic_meter_per_mole_second_impl {
            ...
            constexpr cubic_meter_per_mole_second_impl<T, P>() : value(0) {}
            constexpr cubic_meter_per_mole_second_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const cubic_meter_per_mole_second_impl<T, P>(const cubic_meter_per_mole_second_impl<U, R>& other) {
...
#endif // POTATO_UNITS_CUBIC_METER_PER_MOLE_SECOND_HPP_INCLUDED