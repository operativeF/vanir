...
export namespace potato::units {
    ...
    using spectral_irradiance_tag_t = tmp::list_<Length<std::ratio<-1, 1>>,
                                         Time<std::ratio<-3, 1>>,
                                         Mass<std::ratio<1, 1>>,
    ...
    template<typename T>
    concept Watt_Per_Cubic_MeterC = std::same_as<typename T::impl, spectral_irradiance_tag_t>;

    template <typename RatioTypeT, typename P>
    struct watt_per_cubic_meter_impl {
        ...
        using impl       = spectral_irradiance_tag_t;

        constexpr watt_per_cubic_meter_impl(value_type val) : value{val} {}
    ...
    consteval exawatt_per_cubic_meter_ld operator""_EW_per_cubic_m(long double val) {
        return static_cast<exawatt_per_cubic_meter_ld>(val);
    }
    consteval petawatt_per_cubic_meter_ld operator""_PW_per_cubic_m(long double val) {
        return static_cast<petawatt_per_cubic_meter_ld>(val);
    }
    consteval terawatt_per_cubic_meter_ld operator""_TW_per_cubic_m(long double val) {
        return static_cast<terawatt_per_cubic_meter_ld>(val);
    }
    consteval gigawatt_per_cubic_meter_ld operator""_GW_per_cubic_m(long double val) {
        return static_cast<gigawatt_per_cubic_meter_ld>(val);
    }
    consteval megawatt_per_cubic_meter_ld operator""_MW_per_cubic_m(long double val) {
        return static_cast<megawatt_per_cubic_meter_ld>(val);
    }
    consteval kilowatt_per_cubic_meter_ld operator""_kW_per_cubic_m(long double val) {
        return static_cast<kilowatt_per_cubic_meter_ld>(val);
    }
    consteval hectowatt_per_cubic_meter_ld operator""_hW_per_cubic_m(long double val) {
        return static_cast<hectowatt_per_cubic_meter_ld>(val);
    }
    consteval decawatt_per_cubic_meter_ld operator""_daW_per_cubic_m(long double val) {
        return static_cast<decawatt_per_cubic_meter_ld>(val);
    }
    consteval watt_per_cubic_meter_ld operator""_W_per_cubic_m(long double val) {
        return static_cast<watt_per_cubic_meter_ld>(val);
    }
    consteval deciwatt_per_cubic_meter_ld operator""_dW_per_cubic_m(long double val) {
        return static_cast<deciwatt_per_cubic_meter_ld>(val);
    }
    consteval centiwatt_per_cubic_meter_ld operator""_cW_per_cubic_m(long double val) {
        return static_cast<centiwatt_per_cubic_meter_ld>(val);
    }
    consteval milliwatt_per_cubic_meter_ld operator""_mW_per_cubic_m(long double val) {
        return static_cast<milliwatt_per_cubic_meter_ld>(val);
    }
    consteval microwatt_per_cubic_meter_ld operator""_uW_per_cubic_m(long double val) {
        return static_cast<microwatt_per_cubic_meter_ld>(val);
    }
    consteval nanowatt_per_cubic_meter_ld operator""_nW_per_cubic_m(long double val) {
        return static_cast<nanowatt_per_cubic_meter_ld>(val);
    }
    consteval picowatt_per_cubic_meter_ld operator""_pW_per_cubic_m(long double val) {
        return static_cast<picowatt_per_cubic_meter_ld>(val);
    }
    consteval femtowatt_per_cubic_meter_ld operator""_fW_per_cubic_m(long double val) {
        return static_cast<femtowatt_per_cubic_meter_ld>(val);
    }
    consteval attowatt_per_cubic_meter_ld operator""_aW_per_cubic_m(long double val) {
        return static_cast<attowatt_per_cubic_meter_ld>(val);
    }
    consteval exawatt_per_cubic_meter_ull operator""_EW_per_cubic_m(unsigned long long val) {
        return static_cast<exawatt_per_cubic_meter_ull>(val);
    }
    consteval petawatt_per_cubic_meter_ull operator""_PW_per_cubic_m(unsigned long long val) {
        return static_cast<petawatt_per_cubic_meter_ull>(val);
    }
    consteval terawatt_per_cubic_meter_ull operator""_TW_per_cubic_m(unsigned long long val) {
        return static_cast<terawatt_per_cubic_meter_ull>(val);
    }
    consteval gigawatt_per_cubic_meter_ull operator""_GW_per_cubic_m(unsigned long long val) {
        return static_cast<gigawatt_per_cubic_meter_ull>(val);
    }
    consteval megawatt_per_cubic_meter_ull operator""_MW_per_cubic_m(unsigned long long val) {
        return static_cast<megawatt_per_cubic_meter_ull>(val);
    }
    consteval kilowatt_per_cubic_meter_ull operator""_kW_per_cubic_m(unsigned long long val) {
        return static_cast<kilowatt_per_cubic_meter_ull>(val);
    }
    consteval hectowatt_per_cubic_meter_ull operator""_hW_per_cubic_m(unsigned long long val) {
        return static_cast<hectowatt_per_cubic_meter_ull>(val);
    }
    consteval decawatt_per_cubic_meter_ull operator""_daW_per_cubic_m(unsigned long long val) {
        return static_cast<decawatt_per_cubic_meter_ull>(val);
    }
    consteval watt_per_cubic_meter_ull operator""_W_per_cubic_m(unsigned long long val) {
        return static_cast<watt_per_cubic_meter_ull>(val);
    }
    consteval deciwatt_per_cubic_meter_ull operator""_dW_per_cubic_m(unsigned long long val) {
        return static_cast<deciwatt_per_cubic_meter_ull>(val);
    }
    consteval centiwatt_per_cubic_meter_ull operator""_cW_per_cubic_m(unsigned long long val) {
        return static_cast<centiwatt_per_cubic_meter_ull>(val);
    }
    consteval milliwatt_per_cubic_meter_ull operator""_mW_per_cubic_m(unsigned long long val) {
        return static_cast<milliwatt_per_cubic_meter_ull>(val);
    }
    consteval microwatt_per_cubic_meter_ull operator""_uW_per_cubic_m(unsigned long long val) {
        return static_cast<microwatt_per_cubic_meter_ull>(val);
    }
    consteval nanowatt_per_cubic_meter_ull operator""_nW_per_cubic_m(unsigned long long val) {
        return static_cast<nanowatt_per_cubic_meter_ull>(val);
    }
    consteval picowatt_per_cubic_meter_ull operator""_pW_per_cubic_m(unsigned long long val) {
        return static_cast<picowatt_per_cubic_meter_ull>(val);
    }
    consteval femtowatt_per_cubic_meter_ull operator""_fW_per_cubic_m(unsigned long long val) {
        return static_cast<femtowatt_per_cubic_meter_ull>(val);
    }
    consteval attowatt_per_cubic_meter_ull operator""_aW_per_cubic_m(unsigned long long val) {
