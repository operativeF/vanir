...
export namespace potato::units {
    ...
    using gray_per_second_tag_t = tmp::list_<tmp::list_<meter_l, meter_l>, tmp::list_<second_l, second_l, second_l>>;

    template<typename T>
    concept Gray_Per_SecondC = std::same_as<typename T::impl, gray_per_second_tag_t>;
    ...
    struct gray_per_second_impl {
        ...
        using impl       = gray_per_second_tag_t;
