#ifndef POTATO_UNITS_RADIANCE_HPP_INCLUDED
#define POTATO_UNITS_RADIANCE_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct watt_per_steradian_square_meter_impl {
            ...
            constexpr watt_per_steradian_square_meter_impl<T, P>() : value(0) {}
            constexpr watt_per_steradian_square_meter_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const watt_per_steradian_square_meter_impl<T, P>(const watt_per_steradian_square_meter_impl<U, R>& other) {
            ...
            using mod_ratio = T;
            using impl      = list_<list_<gram_l>, list_<second_l, second_l, second_l, steradian_l>>;
        };
...
#endif // POTATO_UNITS_WATT_PER_STERADIAN_SQUARE_METER_HPP_INCLUDED