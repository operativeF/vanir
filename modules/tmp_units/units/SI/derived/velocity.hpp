#ifndef POTATO_UNITS_VELOCITY_HPP_INCLUDED
#define POTATO_UNITS_VELOCITY_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct meter_per_second_impl {
            ...
            constexpr meter_per_second_impl<T, P>() : value(0) {}
            constexpr meter_per_second_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const meter_per_second_impl<T, P>(const meter_per_second_impl<U, R>& other) {
            ...
            using mod_ratio = T;
            using impl      = list_<list_<meter_l>, list_<second_l>>;
        };
        ...
        constexpr exameter_per_second_ld operator""_Em_per_s(long double val) {
            return static_cast<exameter_per_second_ld>(val);
        }
        constexpr petameter_per_second_ld operator""_Pm_per_s(long double val) {
            return static_cast<petameter_per_second_ld>(val);
        }
        constexpr terameter_per_second_ld operator""_Tm_per_s(long double val) {
            return static_cast<terameter_per_second_ld>(val);
        }
        constexpr gigameter_per_second_ld operator""_Gm_per_s(long double val) {
            return static_cast<gigameter_per_second_ld>(val);
        }
        constexpr megameter_per_second_ld operator""_Mm_per_s(long double val) {
            return static_cast<megameter_per_second_ld>(val);
        }
        constexpr kilometer_per_second_ld operator""_km_per_s(long double val) {
            return static_cast<kilometer_per_second_ld>(val);
        }
        constexpr hectometer_per_second_ld operator""_hm_per_s(long double val) {
            return static_cast<hectometer_per_second_ld>(val);
        }
        constexpr decameter_per_second_ld operator""_dam_per_s(long double val) {
            return static_cast<decameter_per_second_ld>(val);
        }
        constexpr meter_per_second_ld operator""_m_per_s(long double val) {
            return static_cast<meter_per_second_ld>(val);
        }
        constexpr decimeter_per_second_ld operator""_dm_per_s(long double val) {
            return static_cast<decimeter_per_second_ld>(val);
        }
        constexpr centimeter_per_second_ld operator""_cm_per_s(long double val) {
            return static_cast<centimeter_per_second_ld>(val);
        }
        constexpr millimeter_per_second_ld operator""_mm_per_s(long double val) {
            return static_cast<millimeter_per_second_ld>(val);
        }
        constexpr micrometer_per_second_ld operator""_um_per_s(long double val) {
            return static_cast<micrometer_per_second_ld>(val);
        }
        constexpr nanometer_per_second_ld operator""_nm_per_s(long double val) {
            return static_cast<nanometer_per_second_ld>(val);
        }
        constexpr picometer_per_second_ld operator""_pm_per_s(long double val) {
            return static_cast<picometer_per_second_ld>(val);
        }
        constexpr femtometer_per_second_ld operator""_fm_per_s(long double val) {
            return static_cast<femtometer_per_second_ld>(val);
        }
        constexpr attometer_per_second_ld operator""_am_per_s(long double val) {
            return static_cast<attometer_per_second_ld>(val);
        }
        constexpr exameter_per_second_ull operator""_Em_per_s(unsigned long long val) {
            return static_cast<exameter_per_second_ull>(val);
        }
        constexpr petameter_per_second_ull operator""_Pm_per_s(unsigned long long val) {
            return static_cast<petameter_per_second_ull>(val);
        }
        constexpr terameter_per_second_ull operator""_Tm_per_s(unsigned long long val) {
            return static_cast<terameter_per_second_ull>(val);
        }
        constexpr gigameter_per_second_ull operator""_Gm_per_s(unsigned long long val) {
            return static_cast<gigameter_per_second_ull>(val);
        }
        constexpr megameter_per_second_ull operator""_Mm_per_s(unsigned long long val) {
            return static_cast<megameter_per_second_ull>(val);
        }
        constexpr kilometer_per_second_ull operator""_km_per_s(unsigned long long val) {
            return static_cast<kilometer_per_second_ull>(val);
        }
        constexpr hectometer_per_second_ull operator""_hm_per_s(unsigned long long val) {
            return static_cast<hectometer_per_second_ull>(val);
        }
        constexpr decameter_per_second_ull operator""_dam_per_s(unsigned long long val) {
            return static_cast<decameter_per_second_ull>(val);
        }
        constexpr meter_per_second_ull operator""_m_per_s(unsigned long long val) {
            return static_cast<meter_per_second_ull>(val);
        }
        constexpr decimeter_per_second_ull operator""_dm_per_s(unsigned long long val) {
            return static_cast<decimeter_per_second_ull>(val);
        }
        constexpr centimeter_per_second_ull operator""_cm_per_s(unsigned long long val) {
            return static_cast<centimeter_per_second_ull>(val);
        }
        constexpr millimeter_per_second_ull operator""_mm_per_s(unsigned long long val) {
            return static_cast<millimeter_per_second_ull>(val);
        }
        constexpr micrometer_per_second_ull operator""_um_per_s(unsigned long long val) {
            return static_cast<micrometer_per_second_ull>(val);
        }
        constexpr nanometer_per_second_ull operator""_nm_per_s(unsigned long long val) {
            return static_cast<nanometer_per_second_ull>(val);
        }
        constexpr picometer_per_second_ull operator""_pm_per_s(unsigned long long val) {
            return static_cast<picometer_per_second_ull>(val);
        }
        constexpr femtometer_per_second_ull operator""_fm_per_s(unsigned long long val) {
            return static_cast<femtometer_per_second_ull>(val);
        }
        constexpr attometer_per_second_ull operator""_am_per_s(unsigned long long val) {
...
#endif // POTATO_UNITS_METER_PER_SECOND_HPP_INCLUDED