#ifndef POTATO_UNITS_PERMEABILITY_HPP_INCLUDED
#define POTATO_UNITS_PERMEABILITY_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct henry_per_meter_impl {
            ...
            constexpr henry_per_meter_impl<T, P>() : value(0) {}
            constexpr henry_per_meter_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const henry_per_meter_impl<T, P>(const henry_per_meter_impl<U, R>& other) {
...
#endif // POTATO_UNITS_HENRY_PER_METER_HPP_INCLUDED