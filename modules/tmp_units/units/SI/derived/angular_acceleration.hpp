#ifndef POTATO_UNITS_ANGULAR_ACCELERATION_HPP_INCLUDED
#define POTATO_UNITS_ANGULAR_ACCELERATION_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct radian_per_square_second_impl {
            ...
            constexpr radian_per_square_second_impl<T, P>() : value(0) {}
            constexpr radian_per_square_second_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const radian_per_square_second_impl<T, P>(const radian_per_square_second_impl<U, R>& other) {
            ...
            using mod_ratio = T;
            using impl      = list_<list_<radian_l>, list_<second_l, second_l>>;
        };
...
#endif // POTATO_UNITS_RADIAN_PER_SQUARE_SECOND_HPP_INCLUDED