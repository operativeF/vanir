...
export namespace potato::units {
    ...
    using ampere_per_meter_tag_t = tmp::list_<tmp::list_<ampere_l>, tmp::list_<meter_l>>;

    template<typename T>
    concept Ampere_Per_MeterC = std::same_as<typename T::impl, ampere_per_meter_tag_t>;
    ...
    struct ampere_per_meter_impl {
        ...
        using impl       = ampere_per_meter_tag_t;
