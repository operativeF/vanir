...
export namespace potato::units {
    ...
    using gram_per_cubic_meter_tag_t = tmp::list_<tmp::list_<gram_l>, tmp::list_<meter_l, meter_l, meter_l>>;

    template<typename T>
    concept Gram_Per_Cubic_MeterC = std::same_as<typename T::impl, gram_per_cubic_meter_tag_t>;
    ...
    struct gram_per_cubic_meter_impl {
        ...
        using impl       = gram_per_cubic_meter_tag_t;
