...
export namespace potato::units {
    ...
    struct gram_per_cubic_meter_impl : base_unit_<RatioTypeT, P> {

        using base_unit_<RatioTypeT, P>::base_unit_;
        template <typename U, typename R>
        constexpr const gram_per_cubic_meter_impl<RatioTypeT, P>(const gram_per_cubic_meter_impl<U, R>& other) {
