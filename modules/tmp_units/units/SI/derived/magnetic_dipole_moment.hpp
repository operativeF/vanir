#ifndef POTATO_UNITS_MAGNETIC_DIPOLE_MOMENT_HPP_INCLUDED
#define POTATO_UNITS_MAGNETIC_DIPOLE_MOMENT_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct joule_per_tesla_impl {
            // Deduce value to determine correct stored value.
            using DV = call_<if_<is_<unsigned long long>, always_<long long>, always_<P>>, P>;

            constexpr joule_per_tesla_impl<T, P>() : value(0) {}
            constexpr joule_per_tesla_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const joule_per_tesla_impl<T, P>(const joule_per_tesla_impl<U, R>& other) {
            ...
            static constexpr auto pretty = "J/T";

            using is_any_impl = false_;

            using mod_ratio = T;
            using impl      = list_<list_<meter_l, meter_l, ampere_l>, list_<>>;
        };

        using exajoule_per_tesla_ld    =     joule_per_tesla_impl<std::exa, long double>;
        using petajoule_per_tesla_ld    =     joule_per_tesla_impl<std::peta, long double>;
        using terajoule_per_tesla_ld    =     joule_per_tesla_impl<std::tera, long double>;
        using gigajoule_per_tesla_ld    =     joule_per_tesla_impl<std::giga, long double>;
        using megajoule_per_tesla_ld    =     joule_per_tesla_impl<std::mega, long double>;
        using kilojoule_per_tesla_ld    =     joule_per_tesla_impl<std::kilo, long double>;
        using hectojoule_per_tesla_ld    =     joule_per_tesla_impl<std::hecto, long double>;
        using decajoule_per_tesla_ld    =     joule_per_tesla_impl<std::deca, long double>;
        using joule_per_tesla_ld    =     joule_per_tesla_impl<unity_ratio, long double>;
        using decijoule_per_tesla_ld    =     joule_per_tesla_impl<std::deci, long double>;
        using centijoule_per_tesla_ld    =     joule_per_tesla_impl<std::centi, long double>;
        using millijoule_per_tesla_ld    =     joule_per_tesla_impl<std::milli, long double>;
        using microjoule_per_tesla_ld    =     joule_per_tesla_impl<std::micro, long double>;
        using nanojoule_per_tesla_ld    =     joule_per_tesla_impl<std::nano, long double>;
        using picojoule_per_tesla_ld    =     joule_per_tesla_impl<std::pico, long double>;
        using femtojoule_per_tesla_ld    =     joule_per_tesla_impl<std::femto, long double>;
        using attojoule_per_tesla_ld    =     joule_per_tesla_impl<std::atto, long double>;
        using exajoule_per_tesla_ull    =     joule_per_tesla_impl<std::exa, unsigned long long>;
        using petajoule_per_tesla_ull    =     joule_per_tesla_impl<std::peta, unsigned long long>;
        using terajoule_per_tesla_ull    =     joule_per_tesla_impl<std::tera, unsigned long long>;
        using gigajoule_per_tesla_ull    =     joule_per_tesla_impl<std::giga, unsigned long long>;
        using megajoule_per_tesla_ull    =     joule_per_tesla_impl<std::mega, unsigned long long>;
        using kilojoule_per_tesla_ull    =     joule_per_tesla_impl<std::kilo, unsigned long long>;
        using hectojoule_per_tesla_ull    =     joule_per_tesla_impl<std::hecto, unsigned long long>;
        using decajoule_per_tesla_ull    =     joule_per_tesla_impl<std::deca, unsigned long long>;
        using joule_per_tesla_ull    =     joule_per_tesla_impl<unity_ratio, unsigned long long>;
        using decijoule_per_tesla_ull    =     joule_per_tesla_impl<std::deci, unsigned long long>;
        using centijoule_per_tesla_ull    =     joule_per_tesla_impl<std::centi, unsigned long long>;
        using millijoule_per_tesla_ull    =     joule_per_tesla_impl<std::milli, unsigned long long>;
        using microjoule_per_tesla_ull    =     joule_per_tesla_impl<std::micro, unsigned long long>;
        using nanojoule_per_tesla_ull    =     joule_per_tesla_impl<std::nano, unsigned long long>;
        using picojoule_per_tesla_ull    =     joule_per_tesla_impl<std::pico, unsigned long long>;
...
#endif // POTATO_UNITS_JOULE_PER_TESLA_HPP_INCLUDED