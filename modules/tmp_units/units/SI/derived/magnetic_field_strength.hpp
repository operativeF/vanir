#ifndef POTATO_UNITS_MAGNETIC_FIELD_STRENGTH_HPP_INCLUDED
#define POTATO_UNITS_MAGNETIC_FIELD_STRENGTH_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct ampere_per_meter_impl {
            ...
            constexpr ampere_per_meter_impl<T, P>() : value(0) {}
            constexpr ampere_per_meter_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const ampere_per_meter_impl<T, P>(const ampere_per_meter_impl<U, R>& other) {
...
#endif // POTATO_UNITS_AMPERE_PER_METER_HPP_INCLUDED