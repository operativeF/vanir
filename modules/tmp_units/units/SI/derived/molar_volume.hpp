#ifndef POTATO_UNITS_MOLAR_VOLUME_HPP_INCLUDED
#define POTATO_UNITS_MOLAR_VOLUME_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct cubic_meter_per_mole_impl {
            ...
            constexpr cubic_meter_per_mole_impl<T, P>() : value(0) {}
            constexpr cubic_meter_per_mole_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const cubic_meter_per_mole_impl<T, P>(const cubic_meter_per_mole_impl<U, R>& other) {
            ...
            using mod_ratio = T;
            using impl      = list_<list_<meter_l, meter_l, meter_l>, list_<mole_l>>;
        };
        ...
        constexpr cubic_exameter_per_mole_ld operator""_cubic_Em_per_mol(long double val) {
            return static_cast<cubic_exameter_per_mole_ld>(val);
        }
        constexpr cubic_petameter_per_mole_ld operator""_cubic_Pm_per_mol(long double val) {
            return static_cast<cubic_petameter_per_mole_ld>(val);
        }
        constexpr cubic_terameter_per_mole_ld operator""_cubic_Tm_per_mol(long double val) {
            return static_cast<cubic_terameter_per_mole_ld>(val);
        }
        constexpr cubic_gigameter_per_mole_ld operator""_cubic_Gm_per_mol(long double val) {
            return static_cast<cubic_gigameter_per_mole_ld>(val);
        }
        constexpr cubic_megameter_per_mole_ld operator""_cubic_Mm_per_mol(long double val) {
            return static_cast<cubic_megameter_per_mole_ld>(val);
        }
        constexpr cubic_kilometer_per_mole_ld operator""_cubic_km_per_mol(long double val) {
            return static_cast<cubic_kilometer_per_mole_ld>(val);
        }
        constexpr cubic_hectometer_per_mole_ld operator""_cubic_hm_per_mol(long double val) {
            return static_cast<cubic_hectometer_per_mole_ld>(val);
        }
        constexpr cubic_decameter_per_mole_ld operator""_cubic_dam_per_mol(long double val) {
            return static_cast<cubic_decameter_per_mole_ld>(val);
        }
        constexpr cubic_meter_per_mole_ld operator""_cubic_m_per_mol(long double val) {
            return static_cast<cubic_meter_per_mole_ld>(val);
        }
        constexpr cubic_decimeter_per_mole_ld operator""_cubic_dm_per_mol(long double val) {
            return static_cast<cubic_decimeter_per_mole_ld>(val);
        }
        constexpr cubic_centimeter_per_mole_ld operator""_cubic_cm_per_mol(long double val) {
            return static_cast<cubic_centimeter_per_mole_ld>(val);
        }
        constexpr cubic_millimeter_per_mole_ld operator""_cubic_mm_per_mol(long double val) {
            return static_cast<cubic_millimeter_per_mole_ld>(val);
        }
        constexpr cubic_micrometer_per_mole_ld operator""_cubic_um_per_mol(long double val) {
            return static_cast<cubic_micrometer_per_mole_ld>(val);
        }
        constexpr cubic_nanometer_per_mole_ld operator""_cubic_nm_per_mol(long double val) {
            return static_cast<cubic_nanometer_per_mole_ld>(val);
        }
        constexpr cubic_picometer_per_mole_ld operator""_cubic_pm_per_mol(long double val) {
            return static_cast<cubic_picometer_per_mole_ld>(val);
        }
        constexpr cubic_femtometer_per_mole_ld operator""_cubic_fm_per_mol(long double val) {
            return static_cast<cubic_femtometer_per_mole_ld>(val);
        }
        constexpr cubic_attometer_per_mole_ld operator""_cubic_am_per_mol(long double val) {
            return static_cast<cubic_attometer_per_mole_ld>(val);
        }
        constexpr cubic_exameter_per_mole_ull operator""_cubic_Em_per_mol(unsigned long long val) {
            return static_cast<cubic_exameter_per_mole_ull>(val);
        }
        constexpr cubic_petameter_per_mole_ull operator""_cubic_Pm_per_mol(unsigned long long val) {
            return static_cast<cubic_petameter_per_mole_ull>(val);
        }
        constexpr cubic_terameter_per_mole_ull operator""_cubic_Tm_per_mol(unsigned long long val) {
            return static_cast<cubic_terameter_per_mole_ull>(val);
        }
        constexpr cubic_gigameter_per_mole_ull operator""_cubic_Gm_per_mol(unsigned long long val) {
            return static_cast<cubic_gigameter_per_mole_ull>(val);
        }
        constexpr cubic_megameter_per_mole_ull operator""_cubic_Mm_per_mol(unsigned long long val) {
            return static_cast<cubic_megameter_per_mole_ull>(val);
        }
        constexpr cubic_kilometer_per_mole_ull operator""_cubic_km_per_mol(unsigned long long val) {
            return static_cast<cubic_kilometer_per_mole_ull>(val);
        }
        constexpr cubic_hectometer_per_mole_ull operator""_cubic_hm_per_mol(unsigned long long val) {
            return static_cast<cubic_hectometer_per_mole_ull>(val);
        }
        constexpr cubic_decameter_per_mole_ull operator""_cubic_dam_per_mol(unsigned long long val) {
            return static_cast<cubic_decameter_per_mole_ull>(val);
        }
        constexpr cubic_meter_per_mole_ull operator""_cubic_m_per_mol(unsigned long long val) {
            return static_cast<cubic_meter_per_mole_ull>(val);
        }
        constexpr cubic_decimeter_per_mole_ull operator""_cubic_dm_per_mol(unsigned long long val) {
            return static_cast<cubic_decimeter_per_mole_ull>(val);
        }
        constexpr cubic_centimeter_per_mole_ull operator""_cubic_cm_per_mol(unsigned long long val) {
            return static_cast<cubic_centimeter_per_mole_ull>(val);
        }
        constexpr cubic_millimeter_per_mole_ull operator""_cubic_mm_per_mol(unsigned long long val) {
            return static_cast<cubic_millimeter_per_mole_ull>(val);
        }
        constexpr cubic_micrometer_per_mole_ull operator""_cubic_um_per_mol(unsigned long long val) {
            return static_cast<cubic_micrometer_per_mole_ull>(val);
        }
        constexpr cubic_nanometer_per_mole_ull operator""_cubic_nm_per_mol(unsigned long long val) {
            return static_cast<cubic_nanometer_per_mole_ull>(val);
        }
        constexpr cubic_picometer_per_mole_ull operator""_cubic_pm_per_mol(unsigned long long val) {
            return static_cast<cubic_picometer_per_mole_ull>(val);
        }
        constexpr cubic_femtometer_per_mole_ull operator""_cubic_fm_per_mol(unsigned long long val) {
            return static_cast<cubic_femtometer_per_mole_ull>(val);
        }
        constexpr cubic_attometer_per_mole_ull operator""_cubic_am_per_mol(unsigned long long val) {
...
#endif // POTATO_UNITS_CUBIC_METER_PER_MOLE_HPP_INCLUDED