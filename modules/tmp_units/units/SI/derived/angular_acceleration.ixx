...
export namespace potato::units {
    ...
    using angular_acceleration_tag_t = tmp::list_<Length<std::ratio<0, 1>>,
                                         Time<std::ratio<-2, 1>>,
                                         Mass<std::ratio<0, 1>>,
    ...
    template<typename T>
    concept Radian_Per_Square_SecondC = std::same_as<typename T::impl, angular_acceleration_tag_t>;
    ...
    struct radian_per_square_second_impl {
        ...
        using impl       = angular_acceleration_tag_t;
    ...
    consteval exaradian_per_square_second_ld operator""_Erad_per_sq_s(long double val) {
        return static_cast<exaradian_per_square_second_ld>(val);
    }
    consteval petaradian_per_square_second_ld operator""_Prad_per_sq_s(long double val) {
        return static_cast<petaradian_per_square_second_ld>(val);
    }
    consteval teraradian_per_square_second_ld operator""_Trad_per_sq_s(long double val) {
        return static_cast<teraradian_per_square_second_ld>(val);
    }
    consteval gigaradian_per_square_second_ld operator""_Grad_per_sq_s(long double val) {
        return static_cast<gigaradian_per_square_second_ld>(val);
    }
    consteval megaradian_per_square_second_ld operator""_Mrad_per_sq_s(long double val) {
        return static_cast<megaradian_per_square_second_ld>(val);
    }
    consteval kiloradian_per_square_second_ld operator""_krad_per_sq_s(long double val) {
        return static_cast<kiloradian_per_square_second_ld>(val);
    }
    consteval hectoradian_per_square_second_ld operator""_hrad_per_sq_s(long double val) {
        return static_cast<hectoradian_per_square_second_ld>(val);
    }
    consteval decaradian_per_square_second_ld operator""_darad_per_sq_s(long double val) {
        return static_cast<decaradian_per_square_second_ld>(val);
    }
    consteval radian_per_square_second_ld operator""_rad_per_sq_s(long double val) {
        return static_cast<radian_per_square_second_ld>(val);
    }
    consteval deciradian_per_square_second_ld operator""_drad_per_sq_s(long double val) {
        return static_cast<deciradian_per_square_second_ld>(val);
    }
    consteval centiradian_per_square_second_ld operator""_crad_per_sq_s(long double val) {
        return static_cast<centiradian_per_square_second_ld>(val);
    }
    consteval milliradian_per_square_second_ld operator""_mrad_per_sq_s(long double val) {
        return static_cast<milliradian_per_square_second_ld>(val);
    }
    consteval microradian_per_square_second_ld operator""_urad_per_sq_s(long double val) {
        return static_cast<microradian_per_square_second_ld>(val);
    }
    consteval nanoradian_per_square_second_ld operator""_nrad_per_sq_s(long double val) {
        return static_cast<nanoradian_per_square_second_ld>(val);
    }
    consteval picoradian_per_square_second_ld operator""_prad_per_sq_s(long double val) {
        return static_cast<picoradian_per_square_second_ld>(val);
    }
    consteval femtoradian_per_square_second_ld operator""_frad_per_sq_s(long double val) {
        return static_cast<femtoradian_per_square_second_ld>(val);
    }
    consteval attoradian_per_square_second_ld operator""_arad_per_sq_s(long double val) {
        return static_cast<attoradian_per_square_second_ld>(val);
    }
    consteval exaradian_per_square_second_ull operator""_Erad_per_sq_s(unsigned long long val) {
        return static_cast<exaradian_per_square_second_ull>(val);
    }
    consteval petaradian_per_square_second_ull operator""_Prad_per_sq_s(unsigned long long val) {
        return static_cast<petaradian_per_square_second_ull>(val);
    }
    consteval teraradian_per_square_second_ull operator""_Trad_per_sq_s(unsigned long long val) {
        return static_cast<teraradian_per_square_second_ull>(val);
    }
    consteval gigaradian_per_square_second_ull operator""_Grad_per_sq_s(unsigned long long val) {
        return static_cast<gigaradian_per_square_second_ull>(val);
    }
    consteval megaradian_per_square_second_ull operator""_Mrad_per_sq_s(unsigned long long val) {
        return static_cast<megaradian_per_square_second_ull>(val);
    }
    consteval kiloradian_per_square_second_ull operator""_krad_per_sq_s(unsigned long long val) {
        return static_cast<kiloradian_per_square_second_ull>(val);
    }
    consteval hectoradian_per_square_second_ull operator""_hrad_per_sq_s(unsigned long long val) {
        return static_cast<hectoradian_per_square_second_ull>(val);
    }
    consteval decaradian_per_square_second_ull operator""_darad_per_sq_s(unsigned long long val) {
        return static_cast<decaradian_per_square_second_ull>(val);
    }
    consteval radian_per_square_second_ull operator""_rad_per_sq_s(unsigned long long val) {
        return static_cast<radian_per_square_second_ull>(val);
    }
    consteval deciradian_per_square_second_ull operator""_drad_per_sq_s(unsigned long long val) {
        return static_cast<deciradian_per_square_second_ull>(val);
    }
    consteval centiradian_per_square_second_ull operator""_crad_per_sq_s(unsigned long long val) {
        return static_cast<centiradian_per_square_second_ull>(val);
    }
    consteval milliradian_per_square_second_ull operator""_mrad_per_sq_s(unsigned long long val) {
        return static_cast<milliradian_per_square_second_ull>(val);
    }
    consteval microradian_per_square_second_ull operator""_urad_per_sq_s(unsigned long long val) {
        return static_cast<microradian_per_square_second_ull>(val);
    }
    consteval nanoradian_per_square_second_ull operator""_nrad_per_sq_s(unsigned long long val) {
        return static_cast<nanoradian_per_square_second_ull>(val);
    }
    consteval picoradian_per_square_second_ull operator""_prad_per_sq_s(unsigned long long val) {
        return static_cast<picoradian_per_square_second_ull>(val);
    }
    consteval femtoradian_per_square_second_ull operator""_frad_per_sq_s(unsigned long long val) {
        return static_cast<femtoradian_per_square_second_ull>(val);
    }
    consteval attoradian_per_square_second_ull operator""_arad_per_sq_s(unsigned long long val) {
