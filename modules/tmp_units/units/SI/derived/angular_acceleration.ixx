...
export namespace potato::units {
    ...
    struct radian_per_square_second_impl : base_unit_<RatioTypeT, P> {

        using base_unit_<RatioTypeT, P>::base_unit_;
        template <typename U, typename R>
        constexpr const radian_per_square_second_impl<RatioTypeT, P>(const radian_per_square_second_impl<U, R>& other) {
