#ifndef POTATO_UNITS_MAGNETOMOTIVE_FORCE_HPP_INCLUDED
#define POTATO_UNITS_MAGNETOMOTIVE_FORCE_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct ampere_radian_impl {
            ...
            constexpr ampere_radian_impl<T, P>() : value(0) {}
            constexpr ampere_radian_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const ampere_radian_impl<T, P>(const ampere_radian_impl<U, R>& other) {
...
#endif // POTATO_UNITS_AMPERE_RADIAN_HPP_INCLUDED