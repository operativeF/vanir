#ifndef POTATO_UNITS_SPECIFIC_ANGULAR_MOMENTUM_HPP_INCLUDED
#define POTATO_UNITS_SPECIFIC_ANGULAR_MOMENTUM_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct newton_meter_second_per_kilogram_impl {
            ...
            constexpr newton_meter_second_per_kilogram_impl<T, P>() : value(0) {}
            constexpr newton_meter_second_per_kilogram_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const newton_meter_second_per_kilogram_impl<T, P>(const newton_meter_second_per_kilogram_impl<U, R>& other) {
...
#endif // POTATO_UNITS_NEWTON_METER_SECOND_PER_KILOGRAM_HPP_INCLUDED