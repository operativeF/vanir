...
export namespace potato::units {
    ...
    struct meter_per_quartic_second_impl : base_unit_<RatioTypeT, P> {

        using base_unit_<RatioTypeT, P>::base_unit_;
        template <typename U, typename R>
        constexpr const meter_per_quartic_second_impl<RatioTypeT, P>(const meter_per_quartic_second_impl<U, R>& other) {
