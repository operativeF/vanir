#ifndef POTATO_UNITS_MOMENT_OF_INERTIA_HPP_INCLUDED
#define POTATO_UNITS_MOMENT_OF_INERTIA_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct gram_square_meter_impl {
            ...
            constexpr gram_square_meter_impl<T, P>() : value(0) {}
            constexpr gram_square_meter_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const gram_square_meter_impl<T, P>(const gram_square_meter_impl<U, R>& other) {
...
#endif // POTATO_UNITS_GRAM_SQUARE_METER_HPP_INCLUDED