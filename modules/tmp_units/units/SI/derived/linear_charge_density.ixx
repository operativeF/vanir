...
export namespace potato::units {
    ...
    using coulomb_per_meter_tag_t = tmp::list_<tmp::list_<second_l, ampere_l>, tmp::list_<meter_l>>;

    template<typename T>
    concept Coulomb_Per_MeterC = std::same_as<typename T::impl, coulomb_per_meter_tag_t>;
    ...
    struct coulomb_per_meter_impl {
        ...
        using impl       = coulomb_per_meter_tag_t;
