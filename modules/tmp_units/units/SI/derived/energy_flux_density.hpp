#ifndef POTATO_UNITS_ENERGY_FLUX_DENSITY_HPP_INCLUDED
#define POTATO_UNITS_ENERGY_FLUX_DENSITY_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct joule_per_square_meter_second_impl {
            ...
            constexpr joule_per_square_meter_second_impl<T, P>() : value(0) {}
            constexpr joule_per_square_meter_second_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const joule_per_square_meter_second_impl<T, P>(const joule_per_square_meter_second_impl<U, R>& other) {
...
#endif // POTATO_UNITS_JOULE_PER_SQUARE_METER_SECOND_HPP_INCLUDED