...
export namespace potato::units {
    ...
    using cubic_meter_tag_t = tmp::list_<tmp::list_<meter_l, meter_l, meter_l>, tmp::list_<>>;

    template<typename T>
    concept Cubic_MeterC = std::same_as<typename T::impl, cubic_meter_tag_t>;
