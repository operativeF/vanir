...
export namespace potato::units {
    ...
    using farad_per_meter_tag_t = tmp::list_<tmp::list_<second_l, second_l, second_l, second_l, ampere_l, ampere_l>, tmp::list_<meter_l, meter_l, meter_l, gram_l>>;

    template<typename T>
    concept Farad_Per_MeterC = std::same_as<typename T::impl, farad_per_meter_tag_t>;
    ...
    struct farad_per_meter_impl {
        ...
        using impl       = farad_per_meter_tag_t;
