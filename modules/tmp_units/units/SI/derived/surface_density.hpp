#ifndef POTATO_UNITS_SURFACE_DENSITY_HPP_INCLUDED
#define POTATO_UNITS_SURFACE_DENSITY_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct gram_per_square_meter_impl {
            ...
            constexpr gram_per_square_meter_impl<T, P>() : value(0) {}
            constexpr gram_per_square_meter_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const gram_per_square_meter_impl<T, P>(const gram_per_square_meter_impl<U, R>& other) {
            ...
            using mod_ratio = T;
            using impl      = list_<list_<gram_l>, list_<meter_l, meter_l>>;
        };
...
#endif // POTATO_UNITS_GRAM_PER_SQUARE_METER_HPP_INCLUDED