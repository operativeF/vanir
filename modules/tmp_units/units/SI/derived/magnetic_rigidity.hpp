#ifndef POTATO_UNITS_MAGNETIC_RIGIDITY_HPP_INCLUDED
#define POTATO_UNITS_MAGNETIC_RIGIDITY_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct tesla_meter_impl {
            ...
            constexpr tesla_meter_impl<T, P>() : value(0) {}
            constexpr tesla_meter_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const tesla_meter_impl<T, P>(const tesla_meter_impl<U, R>& other) {
...
#endif // POTATO_UNITS_TESLA_METER_HPP_INCLUDED