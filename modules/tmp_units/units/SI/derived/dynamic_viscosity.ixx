...
export namespace potato::units {
    ...
    using pascal_second_tag_t = tmp::list_<tmp::list_<gram_l>, tmp::list_<meter_l, second_l>>;

    template<typename T>
    concept Pascal_SecondC = std::same_as<typename T::impl, pascal_second_tag_t>;
    ...
    struct pascal_second_impl {
        ...
        using impl       = pascal_second_tag_t;
