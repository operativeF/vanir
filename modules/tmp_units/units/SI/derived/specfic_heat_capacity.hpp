...
namespace potato {
    namespace units {
        ...
        struct joule_per_kilogram_kelvin_impl {
            ...
            constexpr joule_per_kilogram_kelvin_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const joule_per_kilogram_kelvin_impl<T, P>(const joule_per_kilogram_kelvin_impl<U, R>& other) {
