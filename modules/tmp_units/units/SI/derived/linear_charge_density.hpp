#ifndef POTATO_UNITS_LINEAR_CHARGE_DENSITY_HPP_INCLUDED
#define POTATO_UNITS_LINEAR_CHARGE_DENSITY_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct coulomb_per_meter_impl {
            ...
            constexpr coulomb_per_meter_impl<T, P>() : value(0) {}
            constexpr coulomb_per_meter_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const coulomb_per_meter_impl<T, P>(const coulomb_per_meter_impl<U, R>& other) {
            ...
            using mod_ratio = T;
            using impl      = list_<list_<second_l, ampere_l>, list_<meter_l>>;
        };
...
#endif // POTATO_UNITS_COULOMB_PER_METER_HPP_INCLUDED