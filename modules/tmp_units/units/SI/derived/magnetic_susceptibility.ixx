...
export namespace potato::units {
    ...
    using magnetic_susceptibility_tag_t = tmp::list_<Length<std::ratio<-1, 1>>,
                                         Time<std::ratio<2, 1>>,
                                         Mass<std::ratio<-1, 1>>,
    ...
    template<typename T>
    concept Meter_Per_HenryC = std::same_as<typename T::impl, magnetic_susceptibility_tag_t>;

    template <typename RatioTypeT, typename P>
    struct meter_per_henry_impl {
        ...
        using impl       = magnetic_susceptibility_tag_t;

        constexpr meter_per_henry_impl(value_type val) : value{val} {}
    ...
    consteval exameter_per_henry_ld operator""_Em_per_H(long double val) {
        return static_cast<exameter_per_henry_ld>(val);
    }
    consteval petameter_per_henry_ld operator""_Pm_per_H(long double val) {
        return static_cast<petameter_per_henry_ld>(val);
    }
    consteval terameter_per_henry_ld operator""_Tm_per_H(long double val) {
        return static_cast<terameter_per_henry_ld>(val);
    }
    consteval gigameter_per_henry_ld operator""_Gm_per_H(long double val) {
        return static_cast<gigameter_per_henry_ld>(val);
    }
    consteval megameter_per_henry_ld operator""_Mm_per_H(long double val) {
        return static_cast<megameter_per_henry_ld>(val);
    }
    consteval kilometer_per_henry_ld operator""_km_per_H(long double val) {
        return static_cast<kilometer_per_henry_ld>(val);
    }
    consteval hectometer_per_henry_ld operator""_hm_per_H(long double val) {
        return static_cast<hectometer_per_henry_ld>(val);
    }
    consteval decameter_per_henry_ld operator""_dam_per_H(long double val) {
        return static_cast<decameter_per_henry_ld>(val);
    }
    consteval meter_per_henry_ld operator""_m_per_H(long double val) {
        return static_cast<meter_per_henry_ld>(val);
    }
    consteval decimeter_per_henry_ld operator""_dm_per_H(long double val) {
        return static_cast<decimeter_per_henry_ld>(val);
    }
    consteval centimeter_per_henry_ld operator""_cm_per_H(long double val) {
        return static_cast<centimeter_per_henry_ld>(val);
    }
    consteval millimeter_per_henry_ld operator""_mm_per_H(long double val) {
        return static_cast<millimeter_per_henry_ld>(val);
    }
    consteval micrometer_per_henry_ld operator""_um_per_H(long double val) {
        return static_cast<micrometer_per_henry_ld>(val);
    }
    consteval nanometer_per_henry_ld operator""_nm_per_H(long double val) {
        return static_cast<nanometer_per_henry_ld>(val);
    }
    consteval picometer_per_henry_ld operator""_pm_per_H(long double val) {
        return static_cast<picometer_per_henry_ld>(val);
    }
    consteval femtometer_per_henry_ld operator""_fm_per_H(long double val) {
        return static_cast<femtometer_per_henry_ld>(val);
    }
    consteval attometer_per_henry_ld operator""_am_per_H(long double val) {
        return static_cast<attometer_per_henry_ld>(val);
    }
    consteval exameter_per_henry_ull operator""_Em_per_H(unsigned long long val) {
        return static_cast<exameter_per_henry_ull>(val);
    }
    consteval petameter_per_henry_ull operator""_Pm_per_H(unsigned long long val) {
        return static_cast<petameter_per_henry_ull>(val);
    }
    consteval terameter_per_henry_ull operator""_Tm_per_H(unsigned long long val) {
        return static_cast<terameter_per_henry_ull>(val);
    }
    consteval gigameter_per_henry_ull operator""_Gm_per_H(unsigned long long val) {
        return static_cast<gigameter_per_henry_ull>(val);
    }
    consteval megameter_per_henry_ull operator""_Mm_per_H(unsigned long long val) {
        return static_cast<megameter_per_henry_ull>(val);
    }
    consteval kilometer_per_henry_ull operator""_km_per_H(unsigned long long val) {
        return static_cast<kilometer_per_henry_ull>(val);
    }
    consteval hectometer_per_henry_ull operator""_hm_per_H(unsigned long long val) {
        return static_cast<hectometer_per_henry_ull>(val);
    }
    consteval decameter_per_henry_ull operator""_dam_per_H(unsigned long long val) {
        return static_cast<decameter_per_henry_ull>(val);
    }
    consteval meter_per_henry_ull operator""_m_per_H(unsigned long long val) {
        return static_cast<meter_per_henry_ull>(val);
    }
    consteval decimeter_per_henry_ull operator""_dm_per_H(unsigned long long val) {
        return static_cast<decimeter_per_henry_ull>(val);
    }
    consteval centimeter_per_henry_ull operator""_cm_per_H(unsigned long long val) {
        return static_cast<centimeter_per_henry_ull>(val);
    }
    consteval millimeter_per_henry_ull operator""_mm_per_H(unsigned long long val) {
        return static_cast<millimeter_per_henry_ull>(val);
    }
    consteval micrometer_per_henry_ull operator""_um_per_H(unsigned long long val) {
        return static_cast<micrometer_per_henry_ull>(val);
    }
    consteval nanometer_per_henry_ull operator""_nm_per_H(unsigned long long val) {
        return static_cast<nanometer_per_henry_ull>(val);
    }
    consteval picometer_per_henry_ull operator""_pm_per_H(unsigned long long val) {
        return static_cast<picometer_per_henry_ull>(val);
    }
    consteval femtometer_per_henry_ull operator""_fm_per_H(unsigned long long val) {
        return static_cast<femtometer_per_henry_ull>(val);
    }
    consteval attometer_per_henry_ull operator""_am_per_H(unsigned long long val) {
