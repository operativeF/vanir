...
export namespace potato::units {
    ...
    using meter_per_henry_tag_t = tmp::list_<tmp::list_<second_l, second_l, ampere_l, ampere_l>, tmp::list_<meter_l, gram_l>>;

    template<typename T>
    concept Meter_Per_HenryC = std::same_as<typename T::impl, meter_per_henry_tag_t>;
    ...
    struct meter_per_henry_impl {
        ...
        using impl       = meter_per_henry_tag_t;
