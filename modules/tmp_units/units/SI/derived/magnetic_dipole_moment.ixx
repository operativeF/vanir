...
export module Boost.TMP.Units.Unit.Joule_Per_Tesla;
...
export namespace potato::units {
    ...
    using joule_per_tesla_tag_t = tmp::list_<tmp::list_<meter_l, meter_l, ampere_l>, tmp::list_<>>;

    template<typename T>
    concept Joule_Per_TeslaC = std::same_as<typename T::impl, joule_per_tesla_tag_t>;
    ...
    struct joule_per_tesla_impl {
        ...
        using impl       = joule_per_tesla_tag_t;

        constexpr joule_per_tesla_impl(value_type val) : value{val} {}
