...
export namespace potato::units {
    ...
    using magnetic_dipole_moment_tag_t = tmp::list_<Length<std::ratio<2, 1>>,
                                         Time<std::ratio<0, 1>>,
                                         Mass<std::ratio<0, 1>>,
    ...
    template<typename T>
    concept Joule_Per_TeslaC = std::same_as<typename T::impl, magnetic_dipole_moment_tag_t>;
    ...
    struct joule_per_tesla_impl {
        ...
        using impl       = magnetic_dipole_moment_tag_t;
