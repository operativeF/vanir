#ifndef POTATO_UNITS_MAGNETIC_SUSCEPTIBILITY_HPP_INCLUDED
#define POTATO_UNITS_MAGNETIC_SUSCEPTIBILITY_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct meter_per_henry_impl {
            ...
            constexpr meter_per_henry_impl<T, P>() : value(0) {}
            constexpr meter_per_henry_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const meter_per_henry_impl<T, P>(const meter_per_henry_impl<U, R>& other) {
...
#endif // POTATO_UNITS_METER_PER_HENRY_HPP_INCLUDED