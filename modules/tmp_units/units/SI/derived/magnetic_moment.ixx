...
export namespace potato::units {
    ...
    using weber_meter_tag_t = tmp::list_<tmp::list_<meter_l, meter_l, meter_l, gram_l>, tmp::list_<second_l, second_l, ampere_l>>;

    template<typename T>
    concept Weber_MeterC = std::same_as<typename T::impl, weber_meter_tag_t>;
