#ifndef POTATO_UNITS_FREQUENCY_DRIFT_HPP_INCLUDED
#define POTATO_UNITS_FREQUENCY_DRIFT_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct hertz_per_second_impl {
            ...
            constexpr hertz_per_second_impl<T, P>() : value(0) {}
            constexpr hertz_per_second_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const hertz_per_second_impl<T, P>(const hertz_per_second_impl<U, R>& other) {
...
#endif // POTATO_UNITS_HERTZ_PER_SECOND_HPP_INCLUDED