#ifndef POTATO_UNITS_YANK_HPP_INCLUDED
#define POTATO_UNITS_YANK_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct newton_per_second_impl {
            ...
            constexpr newton_per_second_impl<T, P>() : value(0) {}
            constexpr newton_per_second_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const newton_per_second_impl<T, P>(const newton_per_second_impl<U, R>& other) {
...
#endif // POTATO_UNITS_NEWTON_PER_SECOND_HPP_INCLUDED