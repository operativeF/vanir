#ifndef POTATO_UNITS_TEMPERATURE_GRADIENT_HPP_INCLUDED
#define POTATO_UNITS_TEMPERATURE_GRADIENT_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct kelvin_per_watt_impl {
            ...
            constexpr kelvin_per_watt_impl<T, P>() : value(0) {}
            constexpr kelvin_per_watt_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const kelvin_per_watt_impl<T, P>(const kelvin_per_watt_impl<U, R>& other) {
...
#endif // POTATO_UNITS_KELVIN_PER_WATT_HPP_INCLUDED