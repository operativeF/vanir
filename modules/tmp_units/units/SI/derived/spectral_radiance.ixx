...
export namespace potato::units {
    ...
    using watt_per_steradian_cubic_meter_tag_t = tmp::list_<tmp::list_<gram_l>, tmp::list_<meter_l, second_l, second_l, second_l, steradian_l>>;

    template<typename T>
    concept Watt_Per_Steradian_Cubic_MeterC = std::same_as<typename T::impl, watt_per_steradian_cubic_meter_tag_t>;
    ...
    struct watt_per_steradian_cubic_meter_impl {
        ...
        using impl       = watt_per_steradian_cubic_meter_tag_t;
