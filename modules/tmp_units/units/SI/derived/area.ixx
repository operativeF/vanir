...
export namespace potato::units {
    ...
    using square_meter_tag_t = tmp::list_<tmp::list_<meter_l, meter_l>, tmp::list_<>>;

    template<typename T>
    concept Square_MeterC = std::same_as<typename T::impl, square_meter_tag_t>;
