#ifndef POTATO_UNITS_JERK_HPP_INCLUDED
#define POTATO_UNITS_JERK_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct meter_per_cubic_second_impl {
            ...
            constexpr meter_per_cubic_second_impl<T, P>() : value(0) {}
            constexpr meter_per_cubic_second_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const meter_per_cubic_second_impl<T, P>(const meter_per_cubic_second_impl<U, R>& other) {
            ...
            using mod_ratio = T;
            using impl      = list_<list_<meter_l>, list_<second_l, second_l, second_l>>;
        };
...
#endif // POTATO_UNITS_METER_PER_CUBIC_SECOND_HPP_INCLUDED