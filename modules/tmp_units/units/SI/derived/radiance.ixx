...
export namespace potato::units {
    ...
    struct watt_per_steradian_square_meter_impl : base_unit_<RatioTypeT, P> {

        using base_unit_<RatioTypeT, P>::base_unit_;
        template <typename U, typename R>
        constexpr const watt_per_steradian_square_meter_impl<RatioTypeT, P>(const watt_per_steradian_square_meter_impl<U, R>& other) {
