#ifndef POTATO_UNITS_AREA_HPP_INCLUDED
#define POTATO_UNITS_AREA_HPP_INCLUDED
...
namespace potato {
    namespace units {
        ...
        struct square_meter_impl {
            ...
            constexpr square_meter_impl<T, P>() : value(0) {}
            constexpr square_meter_impl<T, P>(DV val) : value(val) {}

            template <typename U, typename R>
            constexpr const square_meter_impl<T, P>(const square_meter_impl<U, R>& other) {
...
#endif // POTATO_UNITS_SQUARE_METER_HPP_INCLUDED